                ...
                <div className="container mx-auto flex flex-col md:flex-row items-center">
                    ...
                    <div className="md:w-1/2 text-center md:text-left">
                        ...
                        <button
                            ...
                            className="relative inline-flex items-center justify-center px-6 py-2 border-2 border-black bg-[#FFF700] text-black font-semibold rounded-md transition-transform duration-200 ease-out transform hover:translate-x-0 hover:translate-y-0">
                            Get Started
                        </button>
